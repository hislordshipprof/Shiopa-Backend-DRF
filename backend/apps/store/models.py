...
class Currency(models.Model):
    ...
    symbol = models.CharField(max_length=5,null=True, blank=True, help_text="Optional. This is the symbol of the currency e.g $")
    position = models.CharField(max_length=5, choices=POSITION_CHOICES)
    exchange_rate = models.DecimalField(decimal_places=2, max_digits=10,help_text='This is the exchange rate of the currency to dollars')
...
class SEO(models.Model):
    """
    This model contains all SEO requirments for the store
    """
    meta_description = models.TextField(help_text="This is the description that would be shown on search engines")
    keywords = models.TextField(help_text="This are what your stores are related with. It could be seperated with commas \",\"")
    favicon = models.ImageField(upload_to='store', help_text='This is the little icon that would be shown beside your title in the browser')
...
class SocialIcon(models.Model):
    ...
    url = models.URLField(max_length=555, help_text="The URL of your social media page e.g https://facebook.com/my-page")
