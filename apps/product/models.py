...
class Category(models.Model):
    ...
    image = models.ImageField(
        upload_to="images", help_text="This is the image that represents this category.", storage=gd_storage)
...
class Product(models.Model):
    ...
    main_image = models.ImageField(
        upload_to='images', storage=gd_storage, help_text="This is the default image of the product... It would be prioritized over other images")
    thumbnail = models.ImageField(
        upload_to="thumbnail", storage=gd_storage, help_text="This is the smaller version of the main image. It would be autogenerated",
        null=True, blank=True)
    images = models.ManyToManyField(CoreImage)
    ...
    section = models.ManyToManyField(
        Section, related_name='products', blank=True)
